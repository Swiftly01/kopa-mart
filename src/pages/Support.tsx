      ...
      <div className="max-w-2xl mx-auto px-4 pt-6 space-y-5">
        ...
        <div className="card-listing p-5 space-y-3">
          ...
          <div className="flex gap-3">
            <a href="https://www.tiktok.com/@kopamart_ng?" target="_blank" rel="noopener noreferrer" className="size-12 rounded-xl bg-secondary flex items-center justify-center hover:bg-primary/10 transition-colors" title="TikTok">
            ...
            <a href="https://www.instagram.com/kopamart_ng?igsh=MTFzNzN4Y2o2N3E4dw%3D%3D&utm_source=qr" target="_blank" rel="noopener noreferrer" className="size-12 rounded-xl bg-secondary flex items-center justify-center hover:bg-primary/10 transition-colors" title="Instagram">
            ...
            <a href="https://x.com/kopamart?s=21" target="_blank" rel="noopener noreferrer" className="size-12 rounded-xl bg-secondary flex items-center justify-center hover:bg-primary/10 transition-colors" title="X (Twitter)">
